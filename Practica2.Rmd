...
```{r}
 ...
 #diagramas de caja:  distribucion de la variable categorica ‘Alcohol‘ según la variable ‘quality‘
  ggplot(data =data, aes(x=AlcoholCat,y=quality)) + geom_boxplot() 
...
se adopta como criterio que las predicciones obtenidas con el modelo logistico por encima de 0,5 pertenecerian al grupo de calidad alta.
...
```
Se obteniene de esta manera que el modelo logistico tiene una precision superior al 70%.
